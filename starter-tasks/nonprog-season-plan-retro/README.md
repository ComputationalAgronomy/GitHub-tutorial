...
- Retrospective structure is prepared.
- Improvement section exists with placeholders.

## What you need to finish
1. Add 2 "what worked" findings.
2. Add 2 "what did not work" findings.
3. Propose 2 measurable improvement actions for the next semester.
4. Add owners and target dates for each action (student team, TA, or instructor).

## Done criteria
- Output stays concise (target: half page to one page).
